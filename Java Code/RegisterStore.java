...
public class RegisterStore extends AppCompatActivity {
    ...
    public void upload_Store_Images_to_Firebase(){
        try {
            //Storing Image now
            StorageReference storageRef = FirebaseStorage.getInstance("gs://samples.appspot.com").getReference("Store Images");
    ...
    public void upload_Store_Owner_Images_to_Firebase(){
        try {
            //Storing Image now
            StorageReference storageRef = FirebaseStorage.getInstance("gs://samples.appspot.com").getReference("Store Owner Images");
